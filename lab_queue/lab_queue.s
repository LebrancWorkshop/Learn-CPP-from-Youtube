	...
	.globl	__ZN5QueueC2Ei                  ; -- Begin function _ZN5QueueC2Ei
	.p2align	2
__ZN5QueueC2Ei:                         ; @_ZN5QueueC2Ei
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #48
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__ZN5QueueC1Ei                  ; -- Begin function _ZN5QueueC1Ei
	.p2align	2
__ZN5QueueC1Ei:                         ; @_ZN5QueueC1Ei
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #48
	stp	x29, x30, [sp, #32]             ; 16-byte Folded Spill
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__ZN5Queue7displayEv            ; -- Begin function _ZN5Queue7displayEv
	.p2align	2
__ZN5Queue7displayEv:                   ; @_ZN5Queue7displayEv
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #64
...
; %bb.0:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__ZN5Queue7enqueueEi            ; -- Begin function _ZN5Queue7enqueueEi
	.p2align	2
__ZN5Queue7enqueueEi:                   ; @_ZN5Queue7enqueueEi
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #48
	stp	x29, x30, [sp, #32]             ; 16-byte Folded Spill
...
LBB6_3:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__ZN5Queue7is_fullEv            ; -- Begin function _ZN5Queue7is_fullEv
	.p2align	2
__ZN5Queue7is_fullEv:                   ; @_ZN5Queue7is_fullEv
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #16
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__ZN5Queue7dequeueEv            ; -- Begin function _ZN5Queue7dequeueEv
	.p2align	2
...
LBB8_8:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__ZN5Queue8is_emptyEv           ; -- Begin function _ZN5Queue8is_emptyEv
	.p2align	2
__ZN5Queue8is_emptyEv:                  ; @_ZN5Queue8is_emptyEv
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #16
	.cfi_def_cfa_offset 16
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__ZN5Queue4swapEPiS0_           ; -- Begin function _ZN5Queue4swapEPiS0_
	.p2align	2
__ZN5Queue4swapEPiS0_:                  ; @_ZN5Queue4swapEPiS0_
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
...
l_.str.3:                               ; @.str.3
	.asciz	"[ERROR] Queue is already full!!"

l_.str.4:                               ; @.str.4
	.asciz	"[ERROR] Queue is already empty!!"
