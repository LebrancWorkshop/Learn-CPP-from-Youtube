	...
	.globl	__Z12recursive_v1i              ; -- Begin function _Z12recursive_v1i
	.p2align	2
__Z12recursive_v1i:                     ; @_Z12recursive_v1i
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
...
; %bb.0:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__Z12recursive_v2i              ; -- Begin function _Z12recursive_v2i
	.p2align	2
__Z12recursive_v2i:                     ; @_Z12recursive_v2i
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
...
LBB2_2:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__Z14full_recursivei            ; -- Begin function _Z14full_recursivei
	.p2align	2
__Z14full_recursivei:                   ; @_Z14full_recursivei
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
